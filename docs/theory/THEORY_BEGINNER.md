...
$$
\mathrm{SNR}_{\text{lin}} = \frac{P_{\text{sig}}}{P_{\text{noise}}},\qquad \mathrm{SNR}_{\text{dB}} = 10\,\log_{10}\!\left(\mathrm{SNR}_{\text{lin}}\right).
$$

- Если сигнал нормирован на единичную мощность, то при заданном $\mathrm{SNR}_{\text{dB}}$ мощность шума равна $1/\mathrm{SNR}_{\text{lin}}$.
...
$$
s_k(t) = A\, e^{j\,(2\pi f_c t + \varphi_m)},\qquad \varphi_m\in\Big\{\tfrac{2\pi m}{M}\Big\}.
$$
