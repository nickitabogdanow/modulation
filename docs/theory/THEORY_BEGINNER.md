...
- [2. Дискретизация и IQ-представление](#2-дискретизация-и-iq-представление)
- [3. Символы и импульсная фильтрация (кратко)](#3-символы-и-импульсная-фильтрация-кратко)
- [4. Типы модуляций: интуиция и иллюстрации](#4-типы-модуляций-интуиция-и-иллюстрации)
- [5. Искажения канала (impairments)](#5-искажения-канала-impairments)
- [6. Представления и признаки (IQ, STFT, PSD, кумулянты)](#6-представления-и-признаки-iq-stft-psd-кумулянты)
- [7. Модели и обучение (ML и CNN)](#7-модели-и-обучение-ml-и-cnn)
- [8. Оценка качества и разбор ошибок](#8-оценка-качества-и-разбор-ошибок)
- [9. Практические советы и подводные камни](#9-практические-советы-и-подводные-камни)
- [10. Математический минимум (SNR, формулы)](#10-математический-минимум-snr-формулы)
- [11. Мини-глоссарий](#11-мини-глоссарий)
- [12. Как всё это связано с кодом](#12-как-всё-это-связано-с-кодом)

Приложения (подробности): A–K в конце файла.
...
## 2. Дискретизация и IQ-представление
...
## 3. Символы и импульсная фильтрация (кратко)
...
## 4. Типы модуляций: интуиция и иллюстрации
...
## 5. Искажения канала (impairments)
...
## 6. Представления и признаки (IQ, STFT, PSD, кумулянты)
...
## 8. Оценка качества и разбор ошибок
...
## 9. Практические советы и подводные камни
...
## 10. Математический минимум (SNR, формулы)
...
### Приложение A. Импульсное формирование и согласованный приём
...
### Приложение B. Математика популярных модуляций (упрощённо)
...
### Приложение C. Канал: мультипуть, Релея, Райс, Доплер
...
### Приложение D. Несбалансированность I/Q: матричная модель
...
### Приложение E. Синхронизация: тайминг и CFO (интуиция)
...
### Приложение F. STFT и параметры спектрограммы
...
### Приложение G. PSD и метод Уэлча
...
### Приложение H. Кумулянты: определения и интуиция
...
### Приложение I. Циклостационарность (введение)
...
### Приложение J. Основы ML: валидация и обобщение
...
### Приложение K. Основы DL: свёртки, нормализация, регуляризация
...
### Приложение L. Метрики, матрицы ошибок и оценка по SNR
